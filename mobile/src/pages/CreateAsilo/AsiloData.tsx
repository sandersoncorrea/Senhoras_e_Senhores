...
export default function AsiloData() {
  ...
  const params = route.params as AsiloDataRouteParams;

  async function handleCreateAsilo() {
...
//   }
  ...
  return (
    ...
    >
      ...
      <RectButton style={styles.nextButton} onPress={handleCreateAsilo}>
